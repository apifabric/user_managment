...
@Component({
  selector: 'GoogleLogin-home',
  templateUrl: './GoogleLogin-home.component.html',
  styleUrls: ['./GoogleLogin-home.component.scss']
})
export class GoogleLoginHomeComponent implements AfterViewInit {
