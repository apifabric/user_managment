...
@Component({
  selector: 'UserActivity-home',
  templateUrl: './UserActivity-home.component.html',
  styleUrls: ['./UserActivity-home.component.scss']
})
export class UserActivityHomeComponent implements AfterViewInit {
