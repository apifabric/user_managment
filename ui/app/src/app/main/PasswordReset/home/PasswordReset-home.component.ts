...
@Component({
  selector: 'PasswordReset-home',
  templateUrl: './PasswordReset-home.component.html',
  styleUrls: ['./PasswordReset-home.component.scss']
})
export class PasswordResetHomeComponent implements AfterViewInit {
