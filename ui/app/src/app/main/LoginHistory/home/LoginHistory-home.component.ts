...
@Component({
  selector: 'LoginHistory-home',
  templateUrl: './LoginHistory-home.component.html',
  styleUrls: ['./LoginHistory-home.component.scss']
})
export class LoginHistoryHomeComponent implements AfterViewInit {
