...
@Component({
  selector: 'UserUserRole-home',
  templateUrl: './UserUserRole-home.component.html',
  styleUrls: ['./UserUserRole-home.component.scss']
})
export class UserUserRoleHomeComponent implements AfterViewInit {
