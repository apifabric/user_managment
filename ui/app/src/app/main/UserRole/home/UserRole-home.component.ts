...
@Component({
  selector: 'UserRole-home',
  templateUrl: './UserRole-home.component.html',
  styleUrls: ['./UserRole-home.component.scss']
})
export class UserRoleHomeComponent implements AfterViewInit {
