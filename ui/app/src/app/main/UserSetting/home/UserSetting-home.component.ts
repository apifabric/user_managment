...
@Component({
  selector: 'UserSetting-home',
  templateUrl: './UserSetting-home.component.html',
  styleUrls: ['./UserSetting-home.component.scss']
})
export class UserSettingHomeComponent implements AfterViewInit {
