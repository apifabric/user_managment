...
resourcename="usermanagment"  # lower case, only
resourcegroup="usermanagment_rg"
...
# git clone https://github.com/apilogicserver/usermanagment.git
# cd usermanagment
...
az group create --name usermanagment_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group usermanagment_rg --sku S1 --is-linux
az container create --resource-group usermanagment_rg --name usermanagment --image apilogicserver/usermanagment:latest --dns-name-label usermanagment --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//usermanagment.westus.azurecontainer.io:5656'
